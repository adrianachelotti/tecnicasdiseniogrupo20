<%@ taglib uri="/struts-tags" prefix="s" %>  
 <head>
    ...
    <link rel="stylesheet" href='vista/menu_style.css' type="text/css" />
...
<table id="tablaLogin" height ="200" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td width="800" bgcolor="#F0F0F0" align="center">
				<s:form action="Autenticador" cssClass="form">  
					<font>Usuario</font>
					<input class="elegante" type ="text" name="usuario" size="24"/>
					<font>Clave</font>
